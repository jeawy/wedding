$(function () {
  ...
  $image.cropper({
    ...
    built: function () {
      ...
      $image.cropper("setCropBoxData", { width: window.innerWidth/4  });
      $image.cropper("setCanvasData", { left:0, width: window.innerWidth/3, height: 400 });
    }
  });
 
    // Methods for moblie
  $('.docs-buttons').on('touchstart click', '[data-method]', function () {
    var $this = $(this);
    var data = $this.data();
    var $target;
    var result;
